...
class AllocationRetryIntegrationTest {
    ...
    @MockBean
    private lateinit var allocationProcessor: AllocationProcessor
    ...
    private fun waitForDlqMessage(): Any? {
        repeat(30) {
            val msg = amqpTemplate.receiveAndConvert(RabbitMQConfig.ALLOCATION_DLQ)
